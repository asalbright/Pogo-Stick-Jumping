...
from custom_callbacks import TensorboardCallback, TrainingDesignCallback
...
def train_agents(seed=12345):
    ...
    for REWARD_FUNCTION in REWARD_FUNCTIONS:
        ...
        # Set up callbacks
        log_cb = TensorboardCallback()
        mod_design_cb = TrainingDesignCallback()
        callbacks = CallbackList([log_cb, mod_design_cb])
