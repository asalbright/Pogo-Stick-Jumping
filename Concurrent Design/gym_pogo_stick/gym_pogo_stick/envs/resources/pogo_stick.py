...
class PogoStick:
    ...
    # TODO: Pick a nominal spring k such that w_n varies +/- 30% of nominal value
        # k = 2038 to 7030
    # TODO: Pick a damping ratio range from 0 to 0.01, maybe run a set without changing this
